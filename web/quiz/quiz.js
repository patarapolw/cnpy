    ...
    case "Enter":
      ...
      if (meaning) {
        try {
          ...
          const getIsCurrentVocab = () => state.vocabList[state.i]?.v === v;
          ...
          const explanation = dirtyExplanation || "";
          // Pinyin generated by small LLM is too unreliable, but small LLM are fast
          // .replace(/\(.+?\)/g, "");
